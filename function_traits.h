...
template<typename T>
struct is_function_ptr : integral_constant<bool, is_pointer<T>::value &&
                                                      is_function<remove_pointer_t<T>>::value>
{
};
...
template <typename T>
struct is_functor : conditional_t<is_class<T>::value,
                                  is_functor_impl<T>,
                                  false_type>
{};
...
template<typename F>
struct is_void_func : conditional_t< is_same<typename function_traits<F>::return_type, void>::value,
                                     true_type,
                                     false_type
                                   >
{
